 ...
 prepareEventDates( events) {
  ...
  onPrev = () => {
    ...
    if(countMonth > 0){
      ...
      this.setState({ currentMonthMoment: newMoment, tintColorNext: 'black', tintColorPrev: (countMonth == 1)?'ccc':'black' });
  ...
  onNext = () => {
    ...
    if(countMonth < 5){
      ...
      this.setState({ currentMonthMoment: newMoment, tintColorNext: (countMonth == 3)?'ccc':'black', tintColorPrev: 'black' });
